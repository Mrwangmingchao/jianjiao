<template>
  <div>
    ...
    <div id="titlecon">
      ...
      <p class="titlecon-p">
        <span class="titlecon-p-span1">￥{{this.$route.params.sellp}}</span>
        <span class="titlecon-p-span2">￥{{this.$route.params.oripri}}</span>
      </p>
    ...
    <div id="itemdetail-box">
      <div v-for="data in itemdetail" :key="data['index']" class="itemdetail">
        ...
        <div v-else>
          <img :src="data.content" class="itemdetailImg" />
        </div>
      </div>
    </div>
